...
class MovementManager {
     ...
     * Special rules are:
     * * If last stone landed on owner's gmarchini.kalaha, then it takes another turn
     * * If last stone landed on owner's empty pit, then moves that stone
     *      and all of the opposite pit stones into owner's gmarchini.kalaha
     *
    ...
    private fun applySpecialRules(
        ...
        // !(last stone in owner's gmarchini.kalaha -> take another turn)
    ...
    private fun innerMove(
        ...
        if (isKalaha && currentSide != game.currentSide) {
            // gmarchini.kalaha reached, ignore current movement
